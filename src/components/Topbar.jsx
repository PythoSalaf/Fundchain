...
const Topbar = ({ handleToggle }) => {
  ...
  const {connectWallet, account, isConnected} = useContext(CrowdFundingContext)
  
  return (
    <div className="w-full ">
      <div className="w-[98%] md:w-[98%] mx-auto flex items-center justify-between">
        <div className="w-full flex items-center gap-x-3">
          <div
            className="border-2 border-[#55286F] text-white p-1 cursor-pointer rounded-xl flex items-center justify-center"
